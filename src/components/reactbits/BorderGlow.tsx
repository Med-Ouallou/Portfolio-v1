/**
 * React Bits BorderGlow — adapted from
 * https://github.com/DavidHDev/react-bits/blob/main/src/content/Components/BorderGlow/BorderGlow.jsx
 */
...
function buildGlowVars(glowColor: string, intensity: number) {
  ...
  const h = match ? parseFloat(match[1]) : 40
  const s = match ? parseFloat(match[2]) : 80
  const l = match ? parseFloat(match[3]) : 80
